function [correctlyClassified, classificationErrors] = testAcc(activationFunction, pNet, inputValues, labels)
...
% 
    ...
    for n = 1: testSetSize
        ...
        outputVector = evaluateTwoLayerPerceptron(activationFunction, pNet, inputVector);
...
function outputVector = evaluateTwoLayerPerceptron(activationFunction, pNet, inputVector)
...
% 
    ...
    outputVector = activationFunction(pNet.outputWeights*activationFunction(pNet.hiddenWeights*inputVector));
end